    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-emerald-50 p-4 md:p-8">
        <div className="max-w-3xl mx-auto">
          <Button
            onClick={() => setView("list")}
            className="mb-4 bg-white text-foreground border border-muted"
          >
            ← Back to Tasks
          </Button>
          ...
          <Card className="p-6 md:p-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={`px-4 py-2 rounded-full text-sm font-bold ${getPriorityColor(selectedTicket.severity)}`}
                >
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span
                            className={`px-2 py-1 text-xs rounded-full font-bold ${getPriorityColor(ticket.severity)}`}
                          >
                            {ticket.severity}
                          </span>
                        </div>
