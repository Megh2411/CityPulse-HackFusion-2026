  ...
  return [
    {
      ...
      description: 'Dangerous pothole creating safety hazard',
      ...
      audit: [
        ...
        },
        {
          ...
          details: { statusChange: 'open -> in_progress' },
          fieldChanged: 'status',
          oldValue: 'open',
    ...
    },
    {
      ...
      description: 'Multiple reports of flooding in the downtown area',
    ...
    },
    {
      ...
      actualCompletion: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString(),
      images: [],
      tags: ['lighting'],
      comments: [],
      audit: [
